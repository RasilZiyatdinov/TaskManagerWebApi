        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamRolesId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectTeamRole", x => new { x.ProjectsId, x.TeamRolesId });
                    table.ForeignKey(
                        name: "FK_ProjectTeamRole_Project_ProjectsId",
                        column: x => x.ProjectsId,
                        principalTable: "Project",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectTeamRole_TeamRole_TeamRolesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTeamRole_TeamRolesId",
